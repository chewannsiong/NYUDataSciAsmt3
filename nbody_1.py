"""
	...
	* update_rs
	...
	Most performance gained through this approach.
	...
	for body1 in BODIES.keys():
		for body2 in BODIES.keys():
			if (body1 != body2) and not (body2 in seenit):
				...
				v1[0] -= dx * m2_b # update_vs
				v1[1] -= dy * m2_b # update_vs
				v1[2] -= dz * m2_b # update_vs
				v2[0] += dx * m1_b # update_vs
				v2[1] += dy * m1_b # update_vs
				v2[2] += dz * m1_b # update_vs
				seenit.append(body1)
